    ...
    build: {
      ...
      rollupOptions: {
        input: {
          ...
          tableQuery: "tests/fixtures/table-query.html",
          errorSummary: "tests/fixtures/error-summary.html",
          attachmentList: "tests/fixtures/attachment-list.html",
          searchInput: "tests/fixtures/search-input.html",
        },
      },
    },
  }),
